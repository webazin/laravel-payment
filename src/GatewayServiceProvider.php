...
class GatewayServiceProvider extends ServiceProvider
{
    ...
    private function getProvider()
    {
        if (version_compare(\Illuminate\Foundation\Application::VERSION, '5.0', '<')) {
            $provider = 'Webazin\LaravelPayment\GatewayServiceProviderLaravel4';
            ...
            $provider = 'Webazin\LaravelPayment\GatewayServiceProviderLaravel5';
        }else {
            $provider = 'Webazin\LaravelPayment\GatewayServiceProviderLaravel6';
        }
